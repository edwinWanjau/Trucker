package com.edwanjau11.trucker
...
import com.edwanjau11.trucker.authentication.navigation.NavGraph
...
class MainActivity : ComponentActivity() {
    ...
    @Composable
    private fun NavigateToLoginScreen() = navController.navigate(LoginScreen.route) {
